...
HASH_FUNCTIONS_DECL (option_name, const char *, struct option, option_name_hash_t)
HASH_FUNCTIONS_DECL (option_code, const unsigned *, struct option, option_code_hash_t)
HASH_FUNCTIONS_DECL (dns_zone, const char *, struct dns_zone, dns_zone_hash_t)
HASH_FUNCTIONS_DECL(lease_ip, const unsigned char *, struct lease, lease_ip_hash_t)
HASH_FUNCTIONS_DECL(lease_id, const unsigned char *, struct lease, lease_id_hash_t)
...
OMAPI_OBJECT_ALLOC_DECL (interface, struct interface_info, dhcp_type_interface)
...
HASH_FUNCTIONS_DECL(iasubopt, struct in6_addr *, struct iasubopt, iasubopt_hash_t)
